    ...
    IReadOnlyDictionary<string, object>? Parameters = null)
{
    ...
    /// </summary>
    public FunctionsConfig? Functions => Parameters?.TryGetValue("functions", out var functions) == true ? (FunctionsConfig)functions : null;
    
    /// <summary>
    /// Tool usage configuration for this turn
    /// </summary>
    public IReadOnlyList<Tool>? Tools => Parameters?.TryGetValue("tools", out var tools) == true ? (IReadOnlyList<Tool>)tools : null;
    
    /// <summary>
    /// Response format for structured output (e.g., JSON)
    /// </summary>
    public ResponseFormat? ResponseFormat => Parameters?.TryGetValue("response_format", out var format) == true ? (ResponseFormat)format : null;

    /// <summary>
    /// Creates a user prompt turn
    /// </summary>
    public static PromptTurn User(string content, IReadOnlyDictionary<string, object>? parameters = null) =>
        new(Role: "user", Content: content, Parameters: parameters);
    ...
    /// </summary>
    public static PromptTurn Function(string name, string content, IReadOnlyDictionary<string, object>? parameters = null) =>
        new(Role: "function", Content: content, Name: name, Parameters: parameters);
    
    /// <summary>
    /// Creates a user prompt turn with JSON response format
    /// </summary>
    public static PromptTurn UserWithJsonResponse(string content, IReadOnlyDictionary<string, object>? parameters = null)
    {
    ...
    /// </summary>
    public static PromptTurn UserWithJsonSchema(string content, string schema, IReadOnlyDictionary<string, object>? parameters = null)
    {
        var allParams = parameters != null 
            ? new Dictionary<string, object>(parameters) 
            : new Dictionary<string, object>();
